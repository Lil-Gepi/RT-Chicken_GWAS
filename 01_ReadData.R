...
tasGenoDF <- rTASSEL::readGenotypeTableFromPath(path = "/home/yiwen/RT-Chicken_GWAS/chr_all_gen2.vcf")
tasGenoDF
...
pheno_gen2_picked <- pheno_gen2_notnull[c("ID","BW8","GLUCOM","SEX")] ; row.names(pheno_gen2_picked) <- pheno_gen2_picked$ID ; rm(pheno_gen2_notnull)
